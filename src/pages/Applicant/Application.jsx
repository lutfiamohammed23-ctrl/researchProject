    ...
    const handleSubmit = async (e) => {
        ...
        const payload = {
            ...
            researchInfo: {
                ...
                objectives,
                methodology,
                researchType: researchType.toUpperCase(), // match backend enum
                ...
                <div className="card-body">
                    ...
                    <form className="row g-3" onSubmit={handleSubmit}>
                        ...
                        <div className="col-md-4">
                            ...
                            <input type="text" className="form-control" id="inputEmail5"  value={lastName} onChange={(e) => setLastName(e.target.value)} />
                        </div>
                        <div className="col-md-4">
                            <label htmlFor="inputPassword5" className="form-label">Email</label>
                            <input type="email" className="form-control" id="inputPassword5"  value={email} onChange={(e) => setEmail(e.target.value)} />
                        </div>
                        ...
                        <div className="col-md-4">
                            ...
                            <input type="date" className="form-control" id="inputEmail5"  value={dob} onChange={(e) => setDob(e.target.value)} />
                        </div>
                        <div className="col-md-4">
                        ...
                        <div className="col-md-4">
                            ...
                            <input type="text" className="form-control" id="inputPassword5"  value={passportNumber} onChange={(e) => setPassportNumber(e.target.value)} />
                        </div>
                        ...
                        <div className="col-md-4">
                            ...
                            <input type="text" className="form-control" id="inputPassword5"  value={nationalId} onChange={(e) => setNationalId(e.target.value)} />
                        </div>
                        ...
                        <div className="col-md-4">
                            ...
                            <input type="text" className="form-control" id="inputEmail5"  value={city} onChange={(e) => setCity(e.target.value)} />
                        </div>
                        <div className="col-md-4">
                            <label htmlFor="inputPassword5" className="form-label">Country</label>
                            <input type="text" className="form-control" id="inputPassword5"  value={country} onChange={(e) => setCountry(e.target.value)} />
                        </div>
                        ...
                        <div className="col-md-4">
                            ...
                            <input type="text" className="form-control" id="inputEmail5"  value={institution} onChange={(e) => setInstitution(e.target.value)} />
                        </div>
                        <div className="col-md-4">
                            <label htmlFor="inputPassword5" className="form-label">Position</label>
                            <input type="text" className="form-control" id="inputPassword5"  value={position} onChange={(e) => setPosition(e.target.value)} />
                        </div>
                        ...
                        <div className="col-md-4">
                            ...
                            <input type="text" className="form-control" id="inputEmail5"  value={objectives} onChange={(e) => setObjectives(e.target.value)} />
                        </div>
                        <div className="col-md-4">
                            <label htmlFor="inputPassword5" className="form-label">Methodology</label>
                            <input type="text" className="form-control" id="inputPassword5"  value={methodology} onChange={(e) => setMethodology(e.target.value)} />
                        </div>
                        <div className="col-md-4">
                            <label htmlFor="inputName5" className="form-label">Research Type</label>
                            <input type="text" className="form-control" value={researchType} onChange={(e) => setResearchType(e.target.value)} />
                        </div>
                        <div className="col-md-4">
                            <label htmlFor="inputName5" className="form-label">Research Field</label>
                            <input type="text" className="form-control" value={researchField} onChange={(e) => setResearchField(e.target.value)} />
                        </div>
                        <div className="col-md-4">
                            <label htmlFor="inputEmail5" className="form-label">Start Date</label>
                            <input type="date" className="form-control" id="inputEmail5"  value={startDate} onChange={(e) => setStartDate(e.target.value)} />
                        </div>
                        <div className="col-md-4">
                            <label htmlFor="inputPassword5" className="form-label">End Date</label>
                            <input type="date" className="form-control" id="inputPassword5"  value={endDate} onChange={(e) => setEndDate(e.target.value)} />
                        </div>
                        ...
                        <div className="col-md-4">
                            ...
                            <input type="text" className="form-control" id="inputPassword5"  value={fundingSource} onChange={(e) => setFundingSource(e.target.value)} />
                        </div>


                        <div className="col-md-4">
                            <label htmlFor="inputName5" className="form-label">Expected Outcomes</label>
                            <input type="text" className="form-control" value={expectedOutcomes} onChange={(e) => setExpectedOutcomes(e.target.value)} />
                        </div>
                        <div className="col-md-4">
                            <label htmlFor="inputEmail5" className="form-label">Ethical Considerations</label>
                            <input type="text" className="form-control" id="inputEmail5" value={ethicalConsiderations} onChange={(e) => setEthicalConsiderations(e.target.value)} />
                        </div>
                        <div className="col-md-4">
                            <label htmlFor="inputPassword5" className="form-label">Data Collection Methods</label>
                            <input type="text" className="form-control" id="inputPassword5" value={dataCollectionMethods} onChange={(e) => setDataCollectionMethods(e.target.value)} />
                        </div>
...
//                 methodology,
//                 researchType,
//                 researchField: researchField || department || "General",
//                 startDate,
//                 endDate,
//                 location: location || city || country || "",
//                 budget: parseFloat(budget) || 0,
...
//                 <div className="card-body">
//                     <form className="row g-3" onSubmit={handleSubmit}>
//                         <h2 className="sub-title fs-1">Applicant Information</h2>
//                         <hr />
...
//                             <select className="form-select" value={Nation} onChange={(e) => setNation(e.target.value)} >
...
//                         <h2 className="sub-title fs-1 mt-4">Research Information</h2>
//                         <hr />

//                         {/* Research Info Inputs */}
//                         <div className="col-md-4">
...
//                             <input type="text" className="form-control" value={objectives} onChange={(e) => setObjectives(e.target.value)} />
//                         </div>
//                         <div className="col-md-4">
//                             <label className="form-label">Methodology</label>
//                             <input type="text" className="form-control" value={methodology} onChange={(e) => setMethodology(e.target.value)} />
//                         </div>
//                         <div className="col-md-4">
...
//                             <input type="number" className="form-control" value={budget} onChange={(e) => setBudget(e.target.value)} min="0" step="0.01" />
//                         </div>
//                         <div className="col-md-4">
...
//                             <input type="text" className="form-control" value={fundingSource} onChange={(e) => setFundingSource(e.target.value)} />
//                         </div>
//                         <div className="col-md-4">
...
//                         </div>
//                         <div className="col-md-4">
//                             <label className="form-label">Ethical Considerations</label>
//                             <input type="text" className="form-control" value={ethicalConsiderations} onChange={(e) => setEthicalConsiderations(e.target.value)} />
//                         </div>
//                         <div className="col-md-4">
//                             <label className="form-label">Data Collection Methods</label>
//                             <input type="text" className="form-control" value={dataCollectionMethods} onChange={(e) => setDataCollectionMethods(e.target.value)} />
//                         </div>
//                         <div className="col-md-4">
//                             <label className="form-label">Sample Size</label>
//                             <input type="number" className="form-control" value={sampleSize} onChange={(e) => setSampleSize(e.target.value)} min="0" />
//                         </div>
...
//                             <div className="d-flex flex-wrap gap-4">
//                                 <div className="form-check">
//                                     <input className="form-check-input" type="checkbox" checked={involvesHumanSubjects} onChange={(e) => setInvolvesHumanSubjects(e.target.checked)} />
//                                     <label className="form-check-label">Human Subjects</label>
//                                 </div>
//                                 <div className="form-check">
//                                     <input className="form-check-input" type="checkbox" checked={involvesAnimals} onChange={(e) => setInvolvesAnimals(e.target.checked)} />
//                                     <label className="form-check-label">Animals</label>
//                                 </div>
//                                 <div className="form-check">
//                                     <input className="form-check-input" type="checkbox" checked={involvesSensitiveData} onChange={(e) => setInvolvesSensitiveData(e.target.checked)} />
//                                     <label className="form-check-label">Sensitive Data</label>
//                                 </div>
//                             </div>
//                         </div>

//                         <h2 className="sub-title fs-1 mt-4">Application Information</h2>
//                         <hr />
//                         <div className="col-md-4">
//                             <label className="form-label">Application Type</label>
//                             <select className="form-select" value={applicationType} onChange={(e) => setApplicationType(e.target.value)}>
//                                 <option value="">--- Select Application Type ---</option>
//                                 {ApplicationType.map((type) => (
//                                     <option key={type.value} value={type.value}>
//                                         {type.label}
