...
function Application() {
    ...
    const [selectedtatus, setASelectedStatus] = useState('');
                ...
                <div className="card-body">
                    ...
                    <form className="row g-3">
                        ...
                        <div className="col-md-4">
                            ...
                            <input type="text" className="form-control" id="inputEmail5" placeholder='Last Name' />
                        </div>
                        <div className="col-md-4">
                            <label htmlFor="inputPassword5" className="form-label">Email</label>
                            <input type="email" className="form-control" id="inputPassword5" placeholder='Email' />
                        </div>
                        ...
                        <div className="col-md-4">
                            ...
                            <input type="date" className="form-control" id="inputEmail5" placeholder='Date Of Birth' />
                        </div>
                        <div className="col-md-4">
                            <label htmlFor="inputPassword5" className="form-label">Passport Number</label>
                            <input type="number" className="form-control" id="inputPassword5" placeholder='Passport Number' />
                        </div>
                        ...
                        <div className="col-md-4">
                            ...
                            <input type="number" className="form-control" id="inputPassword5" placeholder='National Id' />
                        </div>
                        ...
                        <div className="col-md-4">
                            ...
                            <input type="text" className="form-control" id="inputEmail5" placeholder='City' />
                        </div>
                        <div className="col-md-4">
                            <label htmlFor="inputPassword5" className="form-label">Country</label>
                            <input type="text" className="form-control" id="inputPassword5" placeholder='Country' />
                        </div>
                        ...
                        <div className="col-md-4">
                            ...
                            <input type="text" className="form-control" id="inputEmail5" placeholder='Institution' />
                        </div>
                        <div className="col-md-4">
                            <label htmlFor="inputPassword5" className="form-label">Position</label>
                            <input type="text" className="form-control" id="inputPassword5" placeholder='Position' />
                        </div>
                        ...
                        <div className="col-md-4">
                            ...
                            <input type="text" className="form-control" id="inputEmail5" placeholder='Objectives' />
                        </div>
                        <div className="col-md-4">
                            <label htmlFor="inputPassword5" className="form-label">Methodology</label>
                            <input type="text" className="form-control" id="inputPassword5" placeholder='Methodology' />
                        </div>


                        <div className="col-md-4">
                            <label htmlFor="inputName5" className="form-label">Research Type</label>
                            <input type="text" className="form-control" placeholder="Research Type" />
                        </div>
                        <div className="col-md-4">
                            <label htmlFor="inputEmail5" className="form-label">Start Date</label>
                            <input type="date" className="form-control" id="inputEmail5" placeholder='Start Date' />
                        </div>
                        <div className="col-md-4">
                            <label htmlFor="inputPassword5" className="form-label">End Date</label>
                            <input type="date" className="form-control" id="inputPassword5" placeholder='End Date' />
                        </div>
                        ...
                        <div className="col-md-4">
                            ...
                            <input type="text" className="form-control" id="inputEmail5" placeholder='Currency' />
                        </div>
                        <div className="col-md-4">
                            <label htmlFor="inputPassword5" className="form-label">Funding Source</label>
                            <input type="text" className="form-control" id="inputPassword5" placeholder='Funding Source' />
                        </div>


                        <div className="col-md-4">
                            <label htmlFor="inputName5" className="form-label">Expected Outcomes</label>
                            <input type="text" className="form-control" placeholder="Expected Outcomes" />
                        </div>
                        <div className="col-md-4">
                            <label htmlFor="inputEmail5" className="form-label">Ethical Considerations</label>
                            <input type="text" className="form-control" id="inputEmail5" placeholder='Ethical Considerations' />
                        </div>
                        <div className="col-md-4">
                            <label htmlFor="inputPassword5" className="form-label">Data Collection Methods</label>
                            <input type="text" className="form-control" id="inputPassword5" placeholder='Data Collection Methods' />
                        </div>
                        ...
                        <div className="col-md-12">
                            ...
                            <input type="text" className="form-control" placeholder="Sample Size" />
                        </div>
                        ...
                        <div className="col-md-4">
                            <label htmlFor="inputEmail5" className="form-label">Position</label>
                            <input type="text" className="form-control" id="inputEmail5" placeholder='Position' />
                        </div>
                        <div className="col-md-4">
                            <label htmlFor="inputPassword5" className="form-label">Application Type</label>
                            <select name="select" className="form-control" value={selectedType} onChange={(e) => setSelectedType(e.target.value)}>
                                <option value="">--- Select Application Type---</option>
                                {ApplicationType.map(status => (
                        ...
                        <div className="col-md-4">
                            <label htmlFor="inputName5" className="form-label">Application Status</label>
                            <select name="select" className="form-control" value={selectedtatus} onChange={(e) => setASelectedStatus(e.target.value)}>
                        ...
                        <div className="col-md-4">
                            ...
                            <input type="number" className="form-control" placeholder="Permit Number" />
                        </div>
                        <div className="col-md-4">
                            <label htmlFor="inputEmail5" className="form-label">Rejection Reason</label>
                            <input type="text" className="form-control" id="inputEmail5" placeholder='Rejection Reason' />
                        </div>
                        <div className="col-md-12">
                            <label htmlFor="inputEmail5" className="form-label">Officer Notes </label>
                            <input type="text" className="form-control" id="inputEmail5" placeholder='Officer Notes ' />
                        </div><br /><br /><br /><br /><br />
