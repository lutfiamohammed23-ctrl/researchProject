...
import api from '../services/AuthService'; // ✅ import your axios instance
...
const Header = () => {
  ...
  useEffect(() => {
    ...
    if (storedFName) setFirstName(storedFName);
    if (storedLName) setlastName(storedLName);
    ...
    try {
      ...
      if (refreshToken) {
        try {
          ...
          // If server call fails, continue with local logout
